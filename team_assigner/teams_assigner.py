...
class TeamAssigner():
    ...
    def get_clustering_model(self, image):
        ...
        kmeans = KMeans(n_cluster = 2, init = "k_means++", n_init = 5)
    ...
    def get_player_color(self, frame, bbox):
        ...
        player_color = kmeans.cluster_center_(player_cluster)
    ...
    def assign_team_color(self, frame, players_track): # players_track is tracks['player'][frame_num]
        ...
        self.kmeans = kmeans
        self.team_color[1] = kmeans.cluster_center_[0]
        self.team_color[2] = kmeans.cluster_center_[1]
    ...
    def get_player_teams(self, frame, bbox, player_id):
        ...
        team_id = self.kmeans.fit(player_color.reshape(-1 ,1))[0]  + 1
